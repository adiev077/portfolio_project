...
import promo from "./../../../assets/images/dark-bg.jpg";
            ...
            <div className={styles['promo_block']}>
                <div className={styles['promo_block_content']}>
                    <div className={styles['promo_block_content_title']}>
                        ...
                        <NavLink to='/ipad' className={styles['promo_block_content_title_btn']}>
                            Buy
                        </NavLink>
                        <p className={styles['promo_block_content_title_p']}>
                            <NavLink to='/ipad' className={styles['promo_block_content_title_p_link']}>
                                Learn More{svgArrow}
                            </NavLink>
                        </p>
                    </div>
