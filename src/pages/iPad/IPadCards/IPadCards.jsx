...
import styles from "./IPadCards.module.scss";
import {NavLink} from "react-router-dom";

function IPadCards(props) {
    ...
    useEffect( () => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch('https://demo1755075.mockable.io/iPadPage');
                    ...
                    {ipad.map((product, index) => (
                        <div className={styles['block_container_content']}>
                            ...
                            <div className={styles['block_container_content_title']}>
                                ...
                                <NavLink to='/' className={styles['block_container_content_title_link']}>
