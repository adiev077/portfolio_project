                ...
                <div className={styles.globalNav_content}>
                    <ul className={styles.globalNav_list}>
                        {navItems.map((item, index) => (
                            <li key={index}>
                                <NavLink to={item.path} className={({ isActive }) => `${styles.nav_item} ${isActive ? styles.active : ""}`}>
                                    {item.svg && <span className={styles.icon}>{item.svg}</span>}
                                    {item.text}
                                </NavLink>
                            </li>
                        ))}
